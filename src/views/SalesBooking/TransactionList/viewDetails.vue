  ...
  <div class="viewDetails">
    ...
    <div class="viewDetails_content">
      <div class="sonBox">
        ...
        <div class="fromDiv">
          <div class="lfLable" style="width: 200px">Success Booking of Unit</div>
        ...
        <div class="viewDetails_content_btn">
          <el-button type="primary" @click="getData('Payment')">Payment Received</el-button>
          <el-button type="primary" @click="getData('Purchaser')">Purchaser</el-button>
          <el-button type="primary" @click="getData('Agent')">Staff & Agent</el-button>
          <el-button type="primary" @click="getData('Modify')">Modify</el-button>
        </div>
      </div>
    </div>
    <el-dialog :title="dynamicData.title" :visible.sync="dialogVisible" width="60%">
      <div>
        <div v-if="dynamicData.title == 'Payment Received'">
          ...
          >
            ...
            <el-table-column label="Cheque Date">
              <template slot-scope="scope">{{$dateFormatNoTime(scope.row.chequeBankDate)}}</template>
            </el-table-column>
...
export default {
  ...
  methods: {
    goBack() {
      this.$router.replace('/SalesBooking/TransactionList')
    },
    getTransaction() {
        ...
        if (res.code == 0) {
          ...
          this.UnitObj = [
...

            {
              ...
              value: ` ${(!!obj.transactionPrice && !!Number(getPrice(obj.price)))? this.roundNum(obj.transactionPrice / getPrice(obj.price)) : 0}`
            },
