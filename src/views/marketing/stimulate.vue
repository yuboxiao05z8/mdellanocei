<template>
  <div class="stimulate">
    ...
    <el-dialog :title="$t('Create/edit the plan')" center :visible.sync="dialogVisible" width="60%" @closed="closedFn">
      <div class="dialogDiv">
        <el-form ref="form" :model="advertisingForm" label-width="150px">
          <el-form-item :label="$t('title')" prop="title" :rules="[{ required: true, message: $t('The title cannot be empty'),trigger: 'blur'},
            { min: 3, max: 60, message: 'The length ranges from 3 to 60 characters', trigger: 'blur' }]">
